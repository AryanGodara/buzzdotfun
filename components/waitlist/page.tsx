  ...
  return (
    <div className="min-h-screen flex flex-col" style={{backgroundColor: '#D7FF7B'}}>
      ...
      <main className="flex-1 px-4 py-4 max-w-sm mx-auto w-full flex flex-col justify-center">
        <div className="bg-white border-2 border-black rounded-md p-4 mb-4" style={{boxShadow: '4px 4px 0px rgba(0,0,0,0.3)'}}>
          <div className="text-center mb-4">
            <h1 className="text-xl font-bold mb-2">💰 CREATOR LOANS - COMING SOON</h1>
            <div className="bg-gray-100 border border-gray-300 rounded p-3 mb-3">
              ...
              <p className="text-xs text-gray-600">Based on Creator Score of {Math.floor(Math.random() * 100)}</p>
            </div>
          </div>
          ...
          {!joined ? (
            ...
            <div className="text-center mb-3">
              <div className="bg-green-100 border-2 border-green-500 rounded p-3">
                <p className="font-bold text-green-800 text-sm">✅ You're on the waitlist!</p>
              </div>
            </div>
          )}

          <div className="bg-orange-50 border border-orange-300 rounded p-3 mb-3">
            <h4 className="font-bold text-orange-800 mb-1 text-sm">🔥 Waitlist members get:</h4>
          ...
          <div className="text-center text-xs text-gray-600">
            <p className="mb-1">Position: #{Math.floor(Math.random() * 500) + 200}</p>
