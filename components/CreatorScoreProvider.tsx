...
const CreatorScoreContext = createContext<CreatorScoreContextType | undefined>(undefined);

export function useCreatorScore() {
  const context = useContext(CreatorScoreContext);
  if (context === undefined) {
    throw new Error('useCreatorScore must be used within a CreatorScoreProvider');
  }
  return context;
}
